        ...
        rules:
            ...
            contains:
                ...
                protocol:
                    ...
                    sample: icmp
                port:
                    description: Port of the Firewall Rule, None/Null if protocol is icmp, gre, or esp
                    type: str
                    returned: always
                    sample: in
                source_ips:
            ...
            argument_spec=dict(
                ...
                rules=dict(
                    ...
                    options=dict(
                        ...
                        protocol={"type": "str", "choices": ["icmp", "udp", "tcp", "gre", "esp"]},
                        port={"type": "str"},
